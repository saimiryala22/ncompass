...
<table style="width:100%" align="left" cellspacing="0" border="1px" bordercolor="#8064A2" cellpadding="5" style="font-family: Helvetica; color:#000;font-size:12px;line-height: 1.5;">
	...
	foreach($testtypes as $testtype){
		...
		if(($testtype['assessment_type']=='BEHAVORIAL_INSTRUMENT')){
			$weightage="No weightage has been given as this is a behavioural instrument.";
		}
		elseif(($testtype['assessment_type']=='FEEDBACK')){
			$weightage="No weightage has been given as this is a Feedback.";
		}
		else{
...
foreach($category as $categorys){
	...
	$catsubname=explode("-",$sub_cat_comp['comp_def_name']);
...
$settings = array(
	...
	//'marker_type'       => array('*', 'star'),
	//'marker_colour'     => array('#008534', '#850000')
	'legend_position' => "outer bottom 13 13",
	'legend_stroke_width' => 0,
	'legend_shadow_opacity' => 0,
	'legend_title' => "Legend", 'legend_colour' => "#666",
	'legend_columns' => 4,
...
$overall_ass.='<br>Each of the assessment methods, Namely Test, In Basket, Case Study are rated on a scale of 1-4 (1: Poor, 2: Average, 3: Good, 4: Very Good). All the ratings have been arrived after a detailed analysis and of all the assessment instruments.
<br><br>
