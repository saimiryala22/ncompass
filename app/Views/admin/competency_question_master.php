    ...
    <div class="row">
											...
											<li class="dd-item" data-id="4">
												...
												<ol class="dd-list">
													<li class="dd-item" data-id="5">
														<div class="h-bg-green dd-handle"><a href="competency_question_master.html">Questions</a></div>
													</li>
													<li class="dd-item" data-id="6">
														<div class="dd-handle"><a href="competency_migration_map_master.html">Migration Maps</a></div>
													</li>
													<li class="dd-item" data-id="6">
		...
		<div class="col-lg-8">
			<div class="panel panel-inverse card-view">
				...
				<div class="panel-body">
					<h5 class="m-t-none m-b-sm">Indicated Question Banks</h5>
					...
					<form method="get" class="form-horizontal">
						...
						<div class="hr-line-dashed"></div>
						<h5 class="m-t-none m-b-sm">Interview Questions</h5>
						<div class="hr-line-dashed"></div>
						<div class="panel-heading hbuilt">
						...
						<div class="table-responsive">
							<table cellpadding="1" cellspacing="1" class="table table-bordered table-striped">
								...
								<tr>
									<td><label><input type="checkbox" value=""></label></td>
									<td><input type="text" value="" id="" class="form-control" name="" name="country" placeholder="Interview Questions"></td>
								</tr>
								</tbody>
							</table>
						</div>
