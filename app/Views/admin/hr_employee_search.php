									...
									<table cellpadding="1" cellspacing="1" id="edit_datable_2" class="table table-hover table-bordered mb-0">
										...
										?>
											<tr class="tooltip-demo" id='emp_row_<?php echo $key?>'>
												...
												<td>
												<a class="mr-10" href="<?php echo BASE_URL; ?>/index/ass_position_emp?ass_type=ASS&ass_id=<?php echo $empdetail['assessment_id']; ?>&pos_id=<?php echo $empdetail['position_id']; ?>&emp_id=<?php echo $empid; ?>" target="_blank"data-original-title="View Report" data-toggle="tooltip"><i class="fa fa-eye text-success m-r-10"></i></a>
												</td>
											</tr>
											<?php
											}
