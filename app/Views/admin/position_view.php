    ...
    <div class="row">
		...
		<div class="form-group">
			<div class="col-sm-offset-4">
				<button class="btn btn-primary btn-sm" type="button" onClick="create_link('position_update?eve_stat&posid=<?php echo $posdetails['position_id']."&hash=".md5(SECRET.$posdetails['position_id']);?>')">Update</button>
				<button class="btn btn-primary btn-sm" type="button" onClick="create_link('position_update?eve_stat')">Create</button>
				<button class="btn btn-primary btn-sm" type="button" onClick="create_link('position_search')">Cancel</button>
			</div>
		</div>
    </div>
</div>
