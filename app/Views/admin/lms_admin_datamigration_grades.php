					...
					<form class='form-horizontal' name="migrate_data" id="migrate_data" method="post">
						...
						<div class="form-group">
							...
							<div class="col-xs-12 col-sm-9">
								<div class="clearfix">
									<input type="file" name="gradesdata" id="gradesdata" value="" class='validate[required,custom[uploadcsv]]'>
								</div>
								<a style="color:blue;cursor:pointer;text-decoration: underline;" href="<?php echo BASE_URL;?>/public/uploads/sample_csv/grades/sample.csv">Sample File</a>
							</div>
						</div>
						<div class="space-2"></div>
						<div class="form-group">
						...
						<div class="space-2"></div>
						<div id="grades_migrate_data"></div>
					</form>
				</div>
			</div>
		</div>
