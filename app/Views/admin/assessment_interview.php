													...
													<li class="dd-item" data-id="4">
														...
														<ol class="dd-list">
															...
															<li class="dd-item" data-id="6">
																<div class="dd-handle"><a href="assessment_add_assessor.html">Add Assessors</a></div>
															</li>
															<li class="dd-item" data-id="6">
																<div class="h-bg-violet dd-handle">Methods</div>
																<ol class="dd-list">
																	<li class="dd-item" data-id="5">
																	...
																	<li class="dd-item" data-id="6">
																		<div class="h-bg-green dd-handle"><a href="assessment_interview.html">Interview</a></div>
				...
				<div class="panel-body">
					...
					<form method="get" class="form-horizontal">
						<div class="form-group">
							<label class="col-sm-3 control-label">Interview</label>
							<div class="col-sm-9">
								<label class="checkbox-inline"> 
									<input value="option1" id="inlineCheckbox1" type="checkbox"> Structured 
								</label> 
								<label class="checkbox-inline">
									<input value="option2" id="inlineCheckbox2" type="checkbox"> Behavorial
								</label>
							</div>
						</div>
						<div class="hr-line-dashed"></div>
