...
<div id='idexceltable'>
	...
	<div id='navbar' class='navbar navbar-default navbar-fixed-top'>
		...
		<div align='center'> <span><b>Competency Based TNI Report</b> </span></div>
		
		<br/>
		
		<span style='float:Left; padding-right:30px;'><b><?php echo $name_details;?></b></span>
	...
	<table id='repheader' style='width:99%' align='center' class='table table-striped table-bordered table-hover'>
		...
		?>
			<tr>
				...
				<td><?php echo $feed_detail['email']; ?></td>
				...
				<td><?php echo $feed_detail['comp_def_name']; ?></td>
				<td><?php echo $feed_detail['comp_def_level_ind_name']; ?></td>
				<td><?php echo $feed_detail['program_name']; ?></td>
				<td><?php echo ($feed_detail['tna_year']==1)?"Current Year":"Next Year"; ?></td>
			</tr>
		<?php } ?>
		</tbody>
	</table> 
