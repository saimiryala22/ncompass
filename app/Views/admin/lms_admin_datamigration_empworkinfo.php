		...
		<div class="col-lg-12">
			<div class="panel panel-inverse card-view">
				...
				<div class="panel-body">
					<form class='form-horizontal' name="migrate_data" id="migrate_data" method="post">
						<div class="form-group">
							...
							<div class="col-xs-12 col-sm-5">
								<div class="clearfix">
									<select name='parent_org' id='parent_org' class='validate[required, multiselect] form-control'>
						...
						<div class="form-group">
							...
							<div class="col-xs-12 col-sm-3">
								<div class="clearfix">
									<input type="file" name="wrkinfo_data" id="wrkinfo_data" value="" class='validate[required,custom[uploadcsv]]'>
								</div>
								<a style="color:blue;cursor:pointer;text-decoration: underline;" href="<?php echo BASE_URL;?>/public/uploads/sample_csv/emp_workdata/sample.csv">Sample File</a>
							</div>
						</div>
						<div class="space-2"></div>
						<div class="form-group">
						...
						<div id="empworkinfo_migrate_data"></div>
					</form>
				</div>
			</div>
		</div>
