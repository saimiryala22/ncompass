...
$(".next_question").click(function(){
	...
	if(def==false){
		...
		var seeker_id=document.getElementById("seeker_id").value;
		...
		$.ajax({type: "GET",url: BASE_URL+"/employee/insert_others_feedback_question_answers?question_id="+question+"&assess_test_id="+assess_test_id+"&type="+testtype+"&assessment_id="+assessment_id+"&seeker_id="+seeker_id+"&ans="+ans+"&qtype="+qtype+"&skip_v=C",
...
$( ".skip_question").click(function() {
	...
	//var ans="";
	//var qtype="";
	$.ajax({type: "GET",url: BASE_URL+"/employee/insert_others_feedback_question_answers?question_id="+question+"&assess_test_id="+assess_test_id+"&type="+testtype+"&assessment_id="+assessment_id+"&seeker_id="+seeker_id+"&ans="+ans+"&qtype="+qtype+"&skip_v="+skip_value,
		success: function(result){
		//alert(result);
		var colors=result;
			var question_id=".question_color"+question;
