$(document).ready(function(){
	$('#questionnaire_master').validationEngine();
	$('#element_validation').validationEngine();
 ...
 $(document).ready(function() {
	...
	if(status!=''){
		if(status=='competency'){
			...
			$('#elements-info').removeClass('active');
			$('#final-info').removeClass('active');
			...
			$('#elements_li').addClass('active');
			$('#elements-info').addClass('active');
			$('#competency-info').removeClass('active');
			$('#questions-info').removeClass('active');
			$('#infomation-info').removeClass('active');
			$('#final-info').removeClass('active');
...
function edit_intray(id){
	...
	xmlhttp.onreadystatechange=function()
	{
		if (xmlhttp.readyState==4 && xmlhttp.status==200)
		{
			document.getElementById("selected_intray_"+id).innerHTML=xmlhttp.responseText;
			//toastr.error(xmlhttp.responseText);
		}
	}
	xmlhttp.open("GET",BASE_URL+"/admin/intray_selected_edit?intray_id="+id,true);
	xmlhttp.send();
