 ...
 $(function(){
	...
	if($("#migrate_data").validationEngine('validate')){
		...
		// }
            ...
            $.ajax({
                url: BASE_URL+"/admin/grades_data_migrate?files&parent_org_id="+parent_org,
                type: 'POST',
                data: data,
                cache: false,
                dataType: 'json',
                ...
                success: function(data, textStatus, jqXHR){
                    if(typeof data.error === 'undefined'){
                        ...
                        //alert(data);
                        document.getElementById('grades_migrate_data').innerHTML=data;
        ...
        function submitForm(event, data){
            ...
            formData=data;
            $.ajax({
                url: BASE_URL+"/admin/grades_data_migrate",
                type: 'POST',
                data: formData,
                cache: false,
                dataType: 'json',
