...
function setValue_population(){
	...
	var chkd = document.tna_form_tni_controls.tna_emp_population.checked || document.tna_form_tni_controls.tna_mang_population.checked||  document.tna_form_tni_controls.tna_view_population.checked;
	if (chkd) {
      return true; //Submit the form
    } else {
	alertify.alert("please check the checkbox if you want Allow Employee to Add/update or Allow Manager to Add/update or Allow Employee and Manager only to view");
